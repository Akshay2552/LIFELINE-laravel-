...
<ul id='dropdown1' class='dropdown-content'>
 ...
 <li><a href='#'>IIT BOMBAY</a></li>
  ...
  <div id="index-banner" class="parallax-container">
    ...
    <div class="parallax"><img src="back2.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <br><br>
...
<div class="row" style="margin-left:370px;">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
			   ...
			   <form class="s6" method="POST" action="{{ url('login') }}" role="form">
	  ...
	  <input type="hidden" name="_token" value="{{ csrf_token() }}">
			...
			<div class="row">
                <div class="input-field col s4 "  style="margin-left:370px;">
		 ...
		 <button class="btn waves-effect waves-light" type="submit" style="margin-left:370px;">LOGIN
